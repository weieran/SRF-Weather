...
class Forecastday(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Forecastday:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Forecastday:
        """Create an instance of Forecastday from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return Forecastday.parse_obj(obj)

        _obj = Forecastday.parse_obj({
            "geolocation": Geolocation.from_dict(obj.get("geolocation")) if obj.get("geolocation") is not None else None,
            "forecast": Forecast3.from_dict(obj.get("forecast")) if obj.get("forecast") is not None else None
        })
        return _obj
